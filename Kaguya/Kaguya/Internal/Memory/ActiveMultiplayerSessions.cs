...
namespace Kaguya.Internal.Memory
{
	...
	public static class ActiveMultiplayerSessions
	{
		...
		public static IMultiplayerSession GetSession(ulong channelId)
		{
			return _activeSessions.FirstOrDefault(x => x.ChannelId == channelId);
		}
		...
		{
			return _activeSessions.Any(x => x.ChannelId == channelId && x.GameType == type);
		}
	}
