...
namespace Kaguya.Internal.PrimitiveExtensions
{
	...
	{
		public static int ToFloor(this double d) { return (int) Math.Floor(d); }
		public static int ToFloor(this decimal d) { return (int) Math.Floor(d); }
		...
		public static string ToShorthandFormat(this int num) { return ToShorthandFormat((long) num); }
	}
}