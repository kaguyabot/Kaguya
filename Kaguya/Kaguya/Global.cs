...
namespace Kaguya
{
	public static class Global
	{
		...
		/// </summary>
		public static List<int> ShardsReady { get; } = new();
		...
		{
			return (DateTimeOffset.Now - Process.GetCurrentProcess().StartTime).Humanize(2, minUnit: TimeUnit.Second,
				maxUnit: TimeUnit.Day);
		}

		public static string GetStartDate()
		{
			return Process.GetCurrentProcess().StartTime.ToLocalTime().ToShortDateString().Replace('/', '.');
		}
