...
namespace Kaguya.Discord.Commands.Fun
{
    ...
    public class Emotion : KaguyaBase<Emotion>
    {
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-hug")]
        public async Task HugCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Hug, user?.Mention));
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-kiss")]
        public async Task KissCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Kiss, user?.Mention));
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-cuddle")]
        public async Task CuddleCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Cuddle, user?.Mention));
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-feed")]
        public async Task FeedCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Feed, user?.Mention));
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-pat")]
        public async Task PatCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Pat, user?.Mention));
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-poke")]
        public async Task PokeCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Poke, user?.Mention));
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-slap")]
        public async Task SlapCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Slap, user?.Mention));
        ...
        [InheritMetadata(CommandMetadata.Summary | CommandMetadata.Remarks)]
        [Command("-tickle")]
        public async Task TickleCommand(SocketGuildUser user = null) => await SendEmbedAsync(await GetEmotionEmbed(EmotionType.Tickle, user?.Mention));
