...
#pragma warning disable 108,114
		public Task<GambleHistory> GetAsync(params object[] key) { throw new NotImplementedException(); }

		[Obsolete("Use the DeleteAsync(GambleHistory value) overload instead.", true)]
		public Task DeleteAsync(params object[] key) { throw new NotImplementedException(); }
