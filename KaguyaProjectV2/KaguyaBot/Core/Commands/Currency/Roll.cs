...
namespace KaguyaProjectV2.KaguyaBot.Core.Commands.Currency
{
    public class Roll : KaguyaBase
    {
        ...
        private RollResult GetRollResult(int roll) => roll switch
        {
        ...
        private double GetMultiplier(RollResult rollResult) => rollResult switch
        {
            RollResult.LOSS => -1,
        ...
        private EmbedColor GetEmbedColorBasedOnRoll(RollResult rollResult) => rollResult switch
        {
