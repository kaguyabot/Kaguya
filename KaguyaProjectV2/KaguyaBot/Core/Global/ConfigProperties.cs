...
namespace KaguyaProjectV2.KaguyaBot.Core.Global
{
    public static class ConfigProperties
    {
        ...
        public const string KaguyaSupportDiscordURL = "https://discord.gg/aumCJhr";
        public const string KaguyaStoreURL = "https://sellix.io/KaguyaStore";
        public const string KaguyaDevInviteURL = "https://discord.com/api/oauth2/authorize?client_id=664032361679159309&permissions=8&scope=bot";
        ...
        public static string Version { get; } = "2.14.2";
