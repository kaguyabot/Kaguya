...
namespace KaguyaProjectV2.KaguyaBot.Core.Handlers.FishEvent
{
    public static class FishEvent
    {
        ...
        public static async Task Trigger(User user, Fish fish, ICommandContext context) => await FishEventTrigger(new FishHandlerEventArgs(user, fish, context));

        private static async Task FishEventTrigger(FishHandlerEventArgs e) =>
